        ...
        >
          <Box sx={{ width: "100%", px: { xs: '4%', sm: '3%', md: '2%' }, pt: { xs: 1, md: 2 }, pb: { xs: 1, md: 2 } }}>
            ...
            >
              ...
              >
                <img
                  src="https://escuela-bancaria.s3.us-east-2.amazonaws.com/e4996483-2f2a-4e64-80a7-6f4c478ebaf9.png"
                  loading="lazy"
                  className="img-header"
              ...
              {patrocinadores_diamante.length > 0 && <Grid size={{ xs: 12, sm: 3, md: 4, lg: 4 }}>
                <Stack
                  direction="column"
                  spacing={1}
                  alignItems="center"
