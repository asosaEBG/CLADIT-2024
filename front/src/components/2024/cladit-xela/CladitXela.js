            ...
            >
              <Grid xs={12} md={6} lg={6} p={3}>
                <Stack spacing={5}>
                  ...
                  <video ref={videoRef} controls style={{ width: "100%" }}>
                    <source
                      src="https://escuela-bancaria.s3.us-east-2.amazonaws.com/V+Ana+Cecilia+y+Adolfo+CLADIT+XELA+2024.mp4"
                      type="video/mp4"
                    />
                  </video>
                </Stack>
              ...
              <Grid xs={12} md={6} lg={6} p={3}>
                ...
                <Typography variant="p">
                  ...
                  <strong>
                    XXI CONGRESO REGIONAL PARA LA PREVENCIÓN DE LAVADO DE DINERO
                  ...
                  <br />
                  <br />
                  CLADIT 2024 presenta una serie de invitados del más alto nivel
