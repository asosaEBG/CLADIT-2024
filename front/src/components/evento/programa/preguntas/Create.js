            ...
            formConfig: [
              {
                ...
                value: "",
                name: "nombre",
                label: "Ingrese el nombre del participante",
                title: "Nombre del participante (opcional)",
              },
              {
                type: 1,
                required: false,
                value: "",
                name: "institucion",
                label: "Ingrese la institución del participante",
                title: "Institución del participante (opcional)",
              },
              {
                type: 8,
                required: true,
